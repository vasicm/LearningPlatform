...
namespace VocabularyBooster.Data.Graph.Helper
{
    ...
    ///     All Credit goes to Oskar Gewalli (https://github.com/wallymathieu) and the Makrill Project
    ///     (https://github.com/NewtonsoftJsonExt/makrill).
    /// </summary>
    public class CustomDictionaryConverter : JsonConverter
    {
        ...
        {
            reader.Read();
            JsonToken startToken = reader.TokenType;
            switch (startToken)
            {
